...
<div class="main-container min-h-screen text-black dark:text-white-dark" :class="[$store.app.navbar]">
            ...
            <div x-data="todolist">
                    ...
                    <ul class="horizontal-list2 flex items-center space-x-4">
                        <li>
                            <div class="group relative flex-1">
                                <div
                                    class="absolute top-1/2 -translate-y-1/2 peer-focus:text-primary ltr:left-[11px] rtl:right-[11px]">
                                ...
                                <input type="text" class="holder peer form-input ltr:pl-10 rtl:pr-10"
                            ...
                            <div class="filter relative inline-block text-left">
                                <form>
                                    <div class="relative inline-block text-left">
                                        <button type="button"
                                            class="dropdown-btn flex items-center justify-between w-full py-2 px-4 rounded-lg bg-white">
                                            Filter by Property
                                            ...
                                            <img class="arrow" src="<?= base_url() ?>assets/imagess/down-arrow.svg"
                                                alt="Dropdown Arrow" />
                                        </button>
                                    </div>
                                </form>
                ...
                <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
                    <div class="overlay absolute z-[5] hidden h-full w-full rounded-md bg-black/60"
                        :class="{ '!block xl:!hidden': isShowTaskMenu }" @click="isShowTaskMenu = !isShowTaskMenu">
                    </div>
                                            ...
                                            <form>
                                                <div class="relative inline-block text-left">
                                                    <button type="button" class="dropdown-btn flex items-center justify-between w-full py-2 px-4 rounded-lg bg-white">
                                                        ...
                                                        <img class="arrow" src="<?= base_url() ?>assets/imagess/down-arrow.svg" alt="Dropdown Arrow" />
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="filter relative inline-block text-left">
                                        <form>
                                            <div class="relative inline-block text-left">
                                                <button type="button"
                                                    class="dropdown-btn flex items-center justify-between py-2 px-4 rounded-lg bg-white">
                                                    10
                                                    <select class="opacity-0 absolute w-px h-full cursor-pointer">
                                                        <option>Filter Option 1</option>
                                                        <option>Filter Option 2</option>
                                                    ...
                                                    <img class="arrow"
                                                        src="<?= base_url() ?>assets/imagess/down-arrow.svg"
                                                        alt="Dropdown Arrow" />
                                                </button>
                                            </div>
                                        </form>
                                    ...
                                    <div class="filter relative inline-block text-left">
                                        <form>
                                            <div class="relative inline-block text-left">
                                                ...
                                                <ul
                                                    class="dropdown-options absolute hidden mt-2 py-1 bg-white border border-gray-300 shadow-lg rounded-lg">
                                                    <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer">Filter
                                                        Option 1</li>
                                                    <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer">Filter
                                                        Option 2</li>
                                                    <li class="px-4 py-2 hover:bg-gray-100 cursor-pointer">Filter
                                ...
                                <div class="table-responsive table-auto grow overflow-x-auto">
                                    <div class="table-auto">
                                        <table class="table-auto" style="table-layout: auto;">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" :id="`chk-${task.id}`"
                                                            class="form-checkbox" :checked="task.status === 'complete'"
                                                            @click.stop="taskComplete(task)"
                                                            :disabled="selectedTab === 'trash'" /></th>
                                                    <th>ID</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap">Residential Flat in Kumarapark,
                                                        Seshadripuram, Bengaluru, Karnataka</td>
                                                    ...
                                                    <td class="whitespace-nowrap">18/08/2023 at 12:17 PM Modified -
                                                        Published</td>
                                                    ...
                                                    <td class="whitespace-nowrap">
                                                        <div class="flex gap-4 items-center">
                                                            <button class="btn-primary viewBtn">
                                                                <img src="<?= base_url() ?>assets/imagess/eye.svg"
                                                                    width="20px" />
                                                            </button>
                                                            ...
                                                            <button
                                                                class="btn-primary menuBtn flex flex-col items-center">
                                                                <img src="<?= base_url() ?>assets/imagess/Ellipse.svg"
                                                                    class=" ellipse mb-0.8" />
                                                                <img src="<?= base_url() ?>assets/imagess/Ellipse-1.svg"
                                                                    class="mb-0.8" />
                                                                <img src="<?= base_url() ?>assets/imagess/Ellipse-2.svg"
                                                                    class="mb-0.8" />
                                                            </button>
                                                        </div>
                                                    </td>
    ...
    <!-- <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60 px-4" :class="{'!block':addTaskModal}">
        <div class="flex min-h-screen items-center justify-center">
            <div x-show="addTaskModal" x-transition x-transition.duration.300 @click.outside="addTaskModal = false"
        ...
        <div class="flex min-h-screen items-center justify-center px-4" @click.self="viewTaskModal = false">
            <div x-show="viewTaskModal" x-transition x-transition.duration.300
                ...
                <div
                    ...
                    <div x-show="selectedTask.tag" x-text="selectedTask.tag" class="badge rounded-3xl capitalize"
                        :class="{
