var FileUploadWithPreview = (function (exports) {
  ...
  (function (Events) {
    ...
    Events["IMAGE_MULTI_ITEM_CLICKED"] =
      "fileUploadWithPreview:imageMultiItemClicked";
  })(exports.Events || (exports.Events = {}));

  var DEFAULT_BASE_IMAGE =
  ...
  var DEFAULT_SUCCESS_VIDEO_IMAGE =
  ...
  var FileUploadWithPreview = /*#__PURE__*/ (function () {
    ...
    function FileUploadWithPreview(uploadId) {
      ...
      this.options.showDeleteButtonOnImages =
        showDeleteButtonOnImages !== null && showDeleteButtonOnImages !== void 0
          ? showDeleteButtonOnImages
          : true;
      this.options.maxFileCount =
        maxFileCount !== null && maxFileCount !== void 0 ? maxFileCount : 0;
      this.options.presetFiles =
        presetFiles !== null && presetFiles !== void 0 ? presetFiles : [];
      this.options.multiple =
        multiple !== null && multiple !== void 0 ? multiple : false; // Text options
      ...
      this.options.text.chooseFile =
        chooseFile !== null && chooseFile !== void 0
          ? chooseFile
          : this.options.text.chooseFile;
      this.options.text.browse =
        browse !== null && browse !== void 0
          ? browse
          : this.options.text.browse;
      this.options.text.label =
        label !== null && label !== void 0 ? label : DEFAULT_LABEL_TEXT;
      this.options.text.selectedCount =
        selectedCount !== null && selectedCount !== void 0
          ? selectedCount
          : this.options.text.selectedCount; // Elements
      ...
      var inputHidden = this.el.querySelector(
        ".custom-file-container .input-hidden"
      );
      var inputVisible = this.el.querySelector(
        ".custom-file-container .input-visible"
      );
      var imagePreview = this.el.querySelector(
        ".custom-file-container .image-preview"
      );
      var clearButton = this.el.querySelector(
        ".custom-file-container .clear-button"
      );
      var allRequiredElementsFound =
        inputHidden != null &&
        inputVisible != null &&
        imagePreview != null &&
        clearButton != null;
      ...
      if (allRequiredElementsFound) {
        ...
        throw new Error(
          "Cannot find all necessary elements for the id: ".concat(
            this.uploadId
          )
        );
      } // Images
      ...
      this.options.images.baseImage =
        baseImage !== null && baseImage !== void 0
          ? baseImage
          : this.options.images.baseImage;
      this.options.images.successPdfImage =
        successPdfImage !== null && successPdfImage !== void 0
          ? successPdfImage
          : this.options.images.successPdfImage;
      this.options.images.successVideoImage =
        successVideoImage !== null && successVideoImage !== void 0
          ? successVideoImage
          : this.options.images.successVideoImage;
      this.options.images.successFileAltImage =
        successFileAltImage !== null && successFileAltImage !== void 0
          ? successFileAltImage
          : this.options.images.successFileAltImage;
    ...
    _createClass(FileUploadWithPreview, [
        ...
        value: function bindClickEvents() {
          ...
          this.clearButton.addEventListener(
            ...
            function () {
              ...
              var clearButtonClickedEvent = new CustomEvent(
                exports.Events.CLEAR_BUTTON_CLICKED,
                eventPayload
              );
          ...
          this.imagePreview.addEventListener("click", function (e) {
            ...
            if (
              ...
              var selectedFileIndex = _this.cachedFileArray.findIndex(function (
                _ref3
              ) {
                var name = _ref3.name;
            ...
            if (target.matches(".custom-file-container .image-preview-item")) {
              var clearIcon = target.querySelector(
              ...
              var _fileName =
                clearIcon === null || clearIcon === void 0
                  ? void 0
                  : clearIcon.getAttribute("data-upload-name");
              ...
              var imageClickedEvent = new CustomEvent(
                exports.Events.IMAGE_MULTI_ITEM_CLICKED,
                eventPayload
              );
      ...
      },
      {
        ...
        value: (function () {
          var _addImagesFromPath = _asyncToGenerator(
            /*#__PURE__*/ regenerator.mark(function _callee2(presetFiles) {
              var _this2 = this;
      ...
      },
      {
        ...
        value: function addFiles(files) {
          ...
          if (this.options.multiple && this.options.maxFileCount > 0) {
            ...
            if (differenceFromMax > 0) {
              fileArray = fileArray.slice(
                0,
                fileArray.length - differenceFromMax
              );
            }
          }
          ...
          fileArray.forEach(function (file) {
            var fileWithUniqueName = new File(
              [file],
              ""
                .concat(file.name || "fallback-name")
                .concat(UNIQUE_ID_IDENTIFIER)
                .concat(generateUniqueId()),
              {
                type: file.type,
              }
            );
          ...
          var imagesAddedEvent = new CustomEvent(
            exports.Events.IMAGE_ADDED,
            eventPayload
          );
      ...
      },
      {
        ...
        value: function addFileToPreviewPanel(file) {
          ...
          if (this.cachedFileArray.length === 0) {
            ...
            this.inputVisible.textContent =
              file.name.split(UNIQUE_ID_IDENTIFIER)[0];
          } else {
            this.inputVisible.innerHTML = ""
              .concat(this.cachedFileArray.length, " ")
          ...
          reader.onload = function () {
            if (!_this4.options.multiple) {
              ...
              if (
                ...
                image = 'url("'.concat(
                  _this4.options.images.successPdfImage,
                  '")'
                );
              } else if (file.type.match("video/*")) {
                image = 'url("'.concat(
                  _this4.options.images.successVideoImage,
                  '")'
                );
              }
            ...
            _this4.imagePreview.style.backgroundImage = 'url("'.concat(
              _this4.options.images.backgroundImage,
              '")'
            );

            var imageClearContent = function imageClearContent(name) {
              return '\n        <span class="image-preview-item-clear">\n          <span class="image-preview-item-clear-icon" data-upload-name="'.concat(
                name,
                '">\n            &times;\n          </span>\n        </span>\n      '
              );
            };
            ...
            _this4.imagePreview.innerHTML +=
              '\n        <div\n          class="image-preview-item"\n          data-upload-name="'
                ...
                .concat(
                  _this4.options.showDeleteButtonOnImages
                    ? imageClearContent(file.name)
                    : undefined,
                  "\n        </div>\n      "
                );
          };
      ...
      },
      {
        ...
        value: function deleteFileAtIndex(index) {
          ...
          this.cachedFileArray = [].concat(
            _toConsumableArray(this.cachedFileArray.slice(0, index)),
            _toConsumableArray(this.cachedFileArray.slice(index + 1))
          );
          this.refreshPreviewPanel();
          var eventPayload = {
            detail: {
          ...
          var imageDeletedEvent = new CustomEvent(
            exports.Events.IMAGE_DELETED,
            eventPayload
          );
      ...
      },
      {
        ...
        value: function refreshPreviewPanel() {
          ...
          var imagePreviewItems = this.imagePreview.querySelectorAll(
            ".image-preview-item"
          );
      ...
      },
      {
        ...
        value: function addBrowseButton(text) {
          this.inputVisible.innerHTML += '<span class="browse-button">'.concat(
            text,
            "</span>"
          );
        },
