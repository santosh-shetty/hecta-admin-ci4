                            ...
                            <table class="table-auto" style="table-layout: auto;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">Residential Flat in Kumarapark, Seshadripuram,
                                            <br>Bengaluru, Karnataka</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">2,149 SFT Residential Flat in Kumarapark West,
                                            <br>Bengaluru, Karnataka</td>
                                        <td class="whitespace-nowrap">₹ 1,20,00,000</td>
                                        <td class="whitespace-nowrap">ICICI Bank</td>
                                        <td class="whitespace-nowrap">September 5, 2023</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap">3 BHK Flat in Pinnacle Apartment Hirandahalli
                                            <br>Bengaluru, Karnataka</td>
                                        <td class="whitespace-nowrap">₹ 1,20,00,000</td>
                                        <td class="whitespace-nowrap">ICICI Bank</td>
                                        <td class="whitespace-nowrap">September 5, 2023</td>
                    ...
                    <div class="panel mb-4">
                        <div class="mb-5 flex items-center justify-between">
                            ...
                            <a class="font-semibold hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-600"
                                href="#"><span class=" view-all flex items-center">
                                    <u>View All</u></span>
                            </a>
                        </div>
                        <div class="mb-5">
