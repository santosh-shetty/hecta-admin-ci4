                        ...
                        <div class="flex w-full flex-col gap-4 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                                                    ...
                                                    <form @submit.prevent="saveUser">
                                                        ...
                                                        <div class="mb-5">
                                                            ...
                                                            <input id="occupation" type="text"
                                                                placeholder="Enter Occupation" class="form-input"
                                                                x-model="params.role" />
                                                        </div>
                                                        <div class="mb-5">
                            ...
                            <div class="relative">
                                <input type="text" placeholder="Search User"
                                    class="peer form-input py-2 ltr:pr-11 rtl:pl-11" x-model="searchUser"
                                    @keyup="searchUsers" />
                                <div
